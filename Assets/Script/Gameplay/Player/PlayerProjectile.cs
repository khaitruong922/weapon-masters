...
public class PlayerProjectile : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag != "Player" && other.gameObject.tag != "AllyProjectile")
    ...
    { //what happens when projectile collides
    ...
    IEnumerator ProjectileTime(float seconds)
    { //destroy projectile after a moment
